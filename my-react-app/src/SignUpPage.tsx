  ...
  return (
    <div
      style={{
        ...
        padding: 20,
        background:
          "radial-gradient(circle at 20% 0%, rgba(76,175,80,0.14), transparent 45%), linear-gradient(180deg, #111316 0%, #0a0c0e 100%)",
      }}
    >
      <div
        style={{
      ...
      >
        <h1 style={{ margin: 0, color: "#f7f4ee", fontSize: 22 }}>Sign Up</h1>
        <p
          style={{
            margin: "8px 0 18px",
        ...
        >
          Create account to save map points later
        </p>
        ...
        <button
          ...
          style={{
            ...
            background: loading ? "rgba(255,255,255,0.18)" : "#4CAF50",
            color: "#fff",
            fontWeight: 700,
          }}
        >
